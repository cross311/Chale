...
{
    [TestClass]
    public class WhenALargeEvenTournamentCompletes
    {
        private Random _rand = new Random();

        private int NumberOfDudes = 50;
        private Tournament _tournament;

        public WhenALargeEvenTournamentCompletes()
        {
        ...
        {
            _tournament.Winner().Name().Should().Be("Dude15");
        }
    }
}
